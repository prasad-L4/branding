  ...
  return (
    <>
      <main className="py-10">
        <div className="flex justify-center  flex-wrap-reverse mt-[-2rem] items-center">
          <div className="flex space-x-4 items-center">
            <h6 className="rotated-text transform rotate-[-90deg] md:w-[9rem] w-[15rem] text-[12px] sm:text-[15px] font-medium">
              OUR SERVICES
            </h6>
            <hr className="w-px bg-gray-300 h-36" />
            <h2 className="font-grotesk font-semibold sm:text-[55px] text-[38px] z-40">
        ...
        <section className="w-[100%] md:mt-[3rem] mt-[3rem] flex justify-center flex-col items-center">
          <div className="w-[90%] flex lg:flex-row flex-col justify-center items-center">
